...
## Javascript Assignments  [![Build Status](https://travis-ci.org/tokotomka/js-assignments-1.svg?branch=master)](https://travis-ci.org/tokotomka/js-assignments-1)
...
```
* Open https://github.com/tokotomka/js-assignments-1 and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
